...
async function restart() {
  ...
  // Local built-output QA has no DATABASE_URL, so PGLite still loads. Nitro
  // does not emit pglite.data/wasm next to the bundled module — copy them so
  // hall RPCs (start/submit) do not crash the preview process.
